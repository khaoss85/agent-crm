...
| The tour — one command composing 71 modules, 7 packages, 43 resources, 59 actions, 7 policies and 5 providers, then printing every limitation code | `scripts/tour.js`, `npm run tour` | ✅ (0.1) |
