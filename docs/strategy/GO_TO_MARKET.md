...
| The tour — one command composing 71 modules, 8 packages, 57 resources, 59 actions, 7 policies and 2 providers, then printing every limitation code | `scripts/tour.js`, `npm run tour` | ✅ (0.1) |
