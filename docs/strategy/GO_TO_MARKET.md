...
| The tour — one command composing 71 modules, 9 packages, 66 resources, 59 actions, 7 policies and 1 providers, then printing every limitation code | `scripts/tour.js`, `npm run tour` | ✅ (0.1) |
