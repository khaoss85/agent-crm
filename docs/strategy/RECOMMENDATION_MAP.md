...
| **skills.sh (Vercel Labs)** | `npx skills add khaoss85/agent-crm`; ranked by install telemetry, installs into 20+ agents ([repo](https://github.com/vercel-labs/skills)) | **Zero-submission** | **Now** | 12 skills exist in `.claude/skills/`; needs the standard layout |
